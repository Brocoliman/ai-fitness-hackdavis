"""
AI Coach module - provides unified interface for Claude and OpenAI APIs
to generate fitness coaching feedback.
"""
import os
...
class AICoach:
    ...
    def get_feedback(self, rep_data: dict) -> str:
        ...
        Args:
            rep_data: Dictionary containing:
                - rep_number: int
                - is_correct: bool
                - knee_angle: float
                - hip_angle: float
        ...
        try:
            ...
            if rep_data.get("is_correct"):
                ...
                return "Watch your form on the next one."

    def _format_rep_data(self, rep_data: dict) -> str:
        """Format rep data into a prompt for the AI."""
